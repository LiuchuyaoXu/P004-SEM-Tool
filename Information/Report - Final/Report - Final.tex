...
\begin{figure*}[htbp]
    ...
    \end{subfigure}
    \caption{Performance test results of the GPU and the CPU}
    \label{Test GPU and CPU}
\end{figure*}

\chapter{Real-time diagnostic tool for SEMs}
\section{Design of the software}

\section{Real-time histogram equalisation for improving image contrast}

\section{Real-time fast Fourier transform for evaluating image focusing and astigmatism} \label{Software FFT}
