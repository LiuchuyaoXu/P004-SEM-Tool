...
\paragraph{}
In image processing, the discrete Fourier transform is used instead of the FT, which takes a finite sequence of equally-spaced values as input and is thus better suited than the FT. It is defined by
\begin{equation}
